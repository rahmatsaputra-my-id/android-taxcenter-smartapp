...
public class Budha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_budha);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        book1 = (PDFView) findViewById(R.id.pdfBuddha);

        book1.fromAsset("Buddha.pdf").load();
    }
}
