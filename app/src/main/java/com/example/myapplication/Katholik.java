...
public class Katholik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katholik);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        book2 = (PDFView) findViewById(R.id.pdfKatholik);

        book2.fromAsset("Katholik.pdf").load();
    }
}
