...
public class Kewarganegaraan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kewarganegaraan);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        book2 = (PDFView) findViewById(R.id.pdfKewarganegaraan);

        book2.fromAsset("Kewarganegaraan.pdf").load();
    }
}
